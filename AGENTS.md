...
Your task it to solve the puzzle located in `task/puzzle.txt`.

You MUST document ALL of your work in the `work/` folder.

You should NEVER: DELETE or EDIT any of your work and MUST document everything you do. If you created a file in `work/` DO NOT EDIT IT, INSTEAD CREATE A NEW ONE.

You can create folders in `work/` folder and `.md` files and whatever you want.
